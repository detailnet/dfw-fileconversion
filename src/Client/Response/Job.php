...
class Job extends BaseResponse
{
    ...
    {
        return $this->getSubResults('actions', [$this, 'createAction'], $asPlainResult);
    }
    ...
    {
        return $this->getSubResults('notifications', [$this, 'createNotification'], $asPlainResult, false);
    }
    ...
    {
        return $this->getSubResults('results', [$this, 'createResult'], $asPlainResult, false);
    }
