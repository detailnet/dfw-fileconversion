    ...
    JobDefinitionInterface
{
    ...
    public function addAction($action)
    {
        ...
        $this->setActions([$action]); // Will get merged with existing actions
        return $this;
    }
    ...
    public function addNotification($notification)
    {
        ...
        $this->setNotifications([$notification]); // Will get merged with existing notifications
        return $this;
    }
}
