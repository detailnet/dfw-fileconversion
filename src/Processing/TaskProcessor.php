    ...
    PausableTaskProcessorInterface
{
    ...
    public function startProcessing(Task\TaskInterface $task)
    {
        ...
        $processId = $this->callAdapter($adapter, __FUNCTION__, [$task]);
    ...
    {
        $adapter = $this->getAdapter($task);
        $result = $this->callAdapter($adapter, __FUNCTION__, [$task]);
    ...
    {
        $adapter = $this->getAdapter($task);
        $result = $this->callAdapter($adapter, __FUNCTION__, [$task, $data], false);
